	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid <?php echo base_url();?>_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?php echo base_url();?/assets/images/se1.jpg">
								<div class="thumb-image">
									<img src="<?php echo base_url();?>assets/images/se1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="<?php echo base_url();?/assets/images/se2.jpg">
								<div class="thumb-image">
									<img src="<?php echo base_url();?>assets/images/se2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="<?php echo base_url();?/assets/images/se3.jpg">
								<div class="thumb-image">
									<img src="<?php echo base_url();?>assets/images/se3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
