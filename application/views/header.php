			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<?php $roll = ['admin'=>'admin','user'=>'user'];
						echo validation_errors(); ?>

						<form action="<?php echo base_url()?>user/create_member" method="post">
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Name" name="first_name" value = "<?php echo set_value('first_name');?>" required = "">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Surname" name="last_name" value = "<?php echo set_value('last_name');?>" required = "" >
							</div>
							<div class="styled-input">
								<input type="email" placeholder="E-mail" name="email_address" value = "<?php echo set_value('email_address');?>" required = "">
							</div>
							<div class="styled-input">
								<input type="text" placeholder="Username" name="username" value = "<?php echo set_value('username');?>" required = "">
							</div>
							<div class="styled-input">
								<select type="text" placeholder="Roll" name="roll" value = "<?php echo set_value('roll');?>" required = "">
									<option value="<?php echo $roll['admin']?>">Admin</option>
									<option value="<?php echo $roll['user']?>">User</option>
								</select>
							</div>
							<div class="styled-input">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li class="active">
									<a class="nav-stylehead" href=""<?php echo base_url();?>user/index">Home
										<span class="sr-only">(current)</span>
									</a>
								</li>
								<li class="">
									<a class="nav-stylehead" href="<?php echo base_url();?>user/about">About Us</a>
								</li>
								<li class="dropdown">
										...
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-4 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li>
														<a href="<?php echo base_url();?>member/allproductview">Bakery</a>
													</li>
													<li>
