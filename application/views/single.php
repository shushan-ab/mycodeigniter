			...
			<div class="col-md-5 single-right-left ">
				<div class="grid <?php echo base_url();?>_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?php echo base_url();?>assets/images/si.jpg">
								<div class="thumb-image">
									<img src="<?php echo base_url();?>assets/images/si.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="<?php echo base_url();?>assets/images/si2.jpg">
								<div class="thumb-image">
									<img src="<?php echo base_url();?>assets/images/si2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="<?php echo base_url();?>assets/images/si3.jpg">
								<div class="thumb-image">
									<img src="<?php echo base_url();?>assets/images/si3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<div class="occasion-cart">
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
						<form action="<?php echo base_url();?>member/profiles#myproducts" method="post">
							<fieldset>
